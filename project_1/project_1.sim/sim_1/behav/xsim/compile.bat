...
REM
REM Generated by Vivado on Mon Apr 11 22:06:39 +0300 2022
...
echo "xvlog --incr --relax -prj test_TOPmare_vlog.prj"
call xvlog  --incr --relax -prj test_TOPmare_vlog.prj -log xvlog.log
